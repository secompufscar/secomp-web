    ...
    return (
        <body className="bg-[#0A0A0A] w-full h-full px-[8%]">
            ...
            <div className="mt-[15rem]">
                ...
                <p className="w-auto text-2xl mt-12 text-white">
                    A SECOMP UFSCar acontece graças ao apoio dos nossos patrocinadores. Eles não apenas compartilham
                    nossa paixão por disseminar conhecimento, mas também são essenciais para tornar o evento educativo,
                ...
                <div>
                    ...
                    <div className="mt-22 flex flex-row justify-center gap-x-[5%] max-md:flex-col max-md:gap-y-7">
                        <div className="flex flex-col items-center gap-y-12">
                            <Image alt={"Logo da empresa"} src={LogoSecomp} />
                            <p className="text-3xl text-white">SECOMP</p>
                        </div>

                        <div className="flex flex-col items-center gap-y-12">
                            <Image alt={"Logo da empresa"} src={LogoSecompOutline} />
                            <p className="text-3xl text-white">SECOMP</p>
                        </div>
                    </div>
                </div>
