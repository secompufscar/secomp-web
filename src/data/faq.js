export const faq = [
  ...
  {
    titulo: 'Como participar das competições?',
  ...
  {
    titulo: 'Como participar dos minicursos?',
  ...
  {
    titulo: 'Quero patrocinar a SECOMP. Como faço?',
  ...
  {
    titulo: 'Consigo ganhar prêmios durante o evento?',
    texto: 'Sim! Os participantes que ficarem no Top 3 do ranking geral da SECOMP receberão prêmios especiais como reconhecimento pelo seu desempenho e engajamento ao longo do evento. Para acompanhar sua posição, acesse nosso aplicativo.'
  },
];