const Modal = ({ show, setShow }) => {
    ...
    return (
        <div
            ...
            <div className="relative w-full max-w-142.5 rounded-lg bg-primary py-12 px-8 text-center md:py-15 md:px-17.5">
                ...
                <h3 className="mt-5.5 pb-2 text-xl font-bold text-white sm:text-4xl">Congratulations!</h3>

                <span className="mx-auto mb-6 inline-block h-1 w-22.5 rounded bg-primary"></span>

                <p className="mb-7.5 font-medium text-white">
