...
export default function Component({ sidebarOpen, setSidebarOpen }) {
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Usuários
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${true && "rotate-180"
                            }`}
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                      ...
                      <div
                        className={`translate transform overflow-hidden ${false && "hidden"
                          }`}
                      >
